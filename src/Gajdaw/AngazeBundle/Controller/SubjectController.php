...
use Gajdaw\AngazeBundle\Form\SubjectType;
...
class SubjectController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GajdawAngazeBundle:Subject')->findAll();
     ...
     * @Method("POST")
     * @Template("GajdawAngazeBundle:Subject:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GajdawAngazeBundle:Subject')->find($id);
     ...
     * @Method("PUT")
     * @Template("GajdawAngazeBundle:Subject:edit.html.twig")
     */
