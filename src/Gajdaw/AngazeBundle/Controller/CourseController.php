...
use Gajdaw\AngazeBundle\Form\CourseType;
...
class CourseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GajdawAngazeBundle:Course')->findAll();
     ...
     * @Method("POST")
     * @Template("GajdawAngazeBundle:Course:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GajdawAngazeBundle:Course')->find($id);
     ...
     * @Method("PUT")
     * @Template("GajdawAngazeBundle:Course:edit.html.twig")
     */
