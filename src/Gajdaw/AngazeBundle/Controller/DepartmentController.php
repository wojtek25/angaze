...
use Gajdaw\AngazeBundle\Form\DepartmentType;
...
class DepartmentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GajdawAngazeBundle:Department')->findAll();
     ...
     * @Method("POST")
     * @Template("GajdawAngazeBundle:Department:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GajdawAngazeBundle:Department')->find($id);
     ...
     * @Method("PUT")
     * @Template("GajdawAngazeBundle:Department:edit.html.twig")
     */
